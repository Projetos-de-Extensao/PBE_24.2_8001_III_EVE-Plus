...
<p align = "justify">
Para a criação da primeira versão do diagrama de classes, a equipe utilizou a extensão PlantUML dentro do Visual Studio Code. 
</p>
...
| -- | -- | -- | -- |
| 24/09/24 | 1.0 | Criação do documento | Paula Oliveira |
